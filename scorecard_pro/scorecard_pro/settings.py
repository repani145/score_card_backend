"""
Django settings for scorecard_pro project.
...
SECRET_KEY = 'django-insecure-!3il=vfw)g1qe0ica^9^t(#_(@rg%)1#yndf!_xcqvb$hv)74o'
...
WSGI_APPLICATION = 'scorecard_pro.wsgi.application'
...
CORS_ALLOW_ALL_ORIGINS = True  # (For testing only; restrict in production)  # for cors
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "gullyygroceryy@gmail.com"
EMAIL_HOST_PASSWORD = "bzhj kmux nwny qxpv"
